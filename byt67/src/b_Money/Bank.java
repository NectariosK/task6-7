...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			//else accountlist.put(accountid,new Account(accountid,this.currency)); in case account doesn't exist
			//accountlist.get(accountid);-nah, this doesn't cut it mate
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			//spits out an error when the user account doesn't exist
			//adding ! works instead of accountlist.containsKey(accountid)
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			//account.deposit(money); come on mate, this doesn't withdraw but deposit instead
		}
	}
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		//transfer(fromaccount, this, fromaccount, amount); transfer of funds 'from to' NOT 'from from'
